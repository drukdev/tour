...
export default function GuideRegistrationForm() {
  ...
  const tourSpecializations = [
    { id: "cultural", label: "Cultural Tours", icon: Heart, description: "Traditional festivals, monasteries, cultural immersion" },
    { id: "adventure", label: "Adventure Tours", icon: Mountain, description: "Trekking, hiking, outdoor activities" },
    { id: "spiritual", label: "Spiritual Tours", icon: Camera, description: "Meditation retreats, spiritual journeys" },
    { id: "photography", label: "Photography Tours", icon: Camera, description: "Landscape and cultural photography" },
    { id: "festival", label: "Festival Tours", icon: Heart, description: "Traditional festivals and celebrations" },
    { id: "wildlife", label: "Wildlife Tours", icon: Mountain, description: "Bird watching, nature exploration" },
    ...tours.map(tour => ({
